...
import { StyleSheet,Text,ScrollView,View,Modal,Alert, Dimensions} from "react-native";
...
export const TrainerPredefinedWorkoutPlanNumberScreen = ({navigation,route }) => {
      ...
      <PageContainer>
          <ScrollView>
              ...
              <View style={styles.container}> 
               ...
               {(publicWorkoutsPlanDaysTable?.length > 0) ? (
                <View style={styles.FromToView}>
                  <Text style={userId === publicWorkoutsPlanRowCon?.trnrId ? styles.totalSets: {fontSize:16,color:"black",marginRight:20,marginLeft:90}}>{t('Sets')}</Text>
              ...
              {(publicWorkoutsPlanDaysTable?.length > 0) ? (
                ...
                //console.log('publicWorkoutsPlanDayArrBeforeSeperateWrkAry--',publicWorkoutsPlanDayArrBeforeSeperateWrkAry);
                  ...
                  return (
                    <View key={speKey} style={styles.viewContainer}>
                      ...
                      {(userId == publicWorkoutsPlanRowCon?.trnrId)?(
                        <CalendarFullSizePressableButton style={{ backgroundColor: '#000', padding: 5, width: 90, height: 'auto', minHeight: 49 }} onPress={() => {navigation.navigate('TrainerPredefinedWorkoutSelectDayExercises', { publicWorkoutsPlanRowConArr: publicWorkoutsPlanRowCon,sentDaySpeKey:speKey,publicWorkoutsPlanDayArrBeforeSeperateWrkArySent:publicWorkoutsPlanDayArrBeforeSeperateWrkAry });}}>
                        ...
                        <CalendarFullSizePressableButton style={{ backgroundColor: '#000', padding: 5, width: 90, height: 'auto', minHeight: 49 }} >
                          <CalendarFullSizePressableButtonText style={{ justifyContent: 'center', textAlign: 'center' }}>{view.dayNam}</CalendarFullSizePressableButtonText>
                        </CalendarFullSizePressableButton>
                      )}
                      </View>
                      ...
                      <View style={styles.removeButtonContainer}>
                          <CalendarFullSizePressableButton style={styles.removeButtonContainerButton} onPress={() => handleRemoveView(publicWorkoutsPlanRowCon?.trnrId, speKey, publicWorkoutsPlanRowCon?.id)}>
                            <CalendarFullSizePressableButtonText>{t('Remove')}</CalendarFullSizePressableButtonText>
                          </CalendarFullSizePressableButton>
                        </View>
                      {/* <View style={styles.removeButtonContainer}>
             ...
             onPress={()=>navigation.navigate('TrainerPredefinedWorkoutSelectDayExercises',{publicWorkoutsPlanRowConArr:publicWorkoutsPlanRowCon})}>
