...
export const TrainerPredefinedMealsSelectMealsScreen = ({navigation,route}) => {
 ...
 if (parsedMalAry?.[i]?.foddes !== undefined  && parsedMalAry?.[i] != '' && parsedMalAry?.[i] !== undefined && parsedMalAry?.[i] !== 'undefined'){
  ...
  const newData={
   ...
   if(triainerConnected){
    axios.post(`https://www.elementdevelops.com/api/trainer-predefined-meal-plan-day-insert`, newData)
    .then((response) => {
