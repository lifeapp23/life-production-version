...
export const CalendarTdeeCalculator = ({navigation,onAddEntry}) => {
  ...
  useFocusEffect(
    React.useCallback(() => {
      ...
      AsyncStorage.getItem("currentUser").then((user) => {
        ...
        //console.log('tdee calculator calendar user---->>>',storedUser);
        fetchCalculatorsTableCalNam(storedUser.id,"tdeeCal").then((calculatorsResults) => {
          //console.log('calculators tdee calendar Results-->',calculatorsResults);
    ...
    <View>
      <Calendar
        ...
        onDayPress={(day) => {
          ...
          navigation.navigate('TDEE',{dayWorkoutWorkedTask:dayWorkoutWorkedTask,sentPassNewDate:presseddDateString})
          onAddEntry();
        }}
      />
      <Spacer size="large">
