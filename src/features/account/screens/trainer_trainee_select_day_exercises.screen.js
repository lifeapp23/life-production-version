...
export const TrainerTraineeSelectDayExercisesScreen = ({ navigation,route}) => {
  ...
  const [loading, setLoading] = useState(false);
        ...
        AsyncStorage.getItem("currentUser").then((user) => {
            ...
            const unsubscribe = addEventListener(state => {
              ...
              if(state.isConnected){
                ...
                axios.get(`https://www.elementdevelops.com/api/get-trainer-trainee-plan-days?traineeId=${publicWorkoutsPlanRowConArr?.trneId}&&trainerId=${publicWorkoutsPlanRowConArr?.trnrId}&planId=${publicWorkoutsPlanRowConArr?.id}`, {
                headers: {
                ...
                .then(response => {
                  ...
                  const filteredArray = response?.data?.["getTraineePlanDays"]?.filter(item => item?.speKey === sentDaySpeKey);
    ...
    // ////////////// End benchesAndRacksData////////////////
      ...
      consFun=()=>{
        const daySpeKey = publicWorkoutsPlanRowConArr?.trnrId + '.' + publicWorkoutsPlanRowConArr?.trneId + '.' + new Date().getTime();
        ...
        //   }));
          ...
          const updatedExercisesWithDayName ={trnrId:publicWorkoutsPlanRowConArr?.trnrId,trneId:publicWorkoutsPlanRowConArr?.trneId,planId:publicWorkoutsPlanRowConArr?.id,speKey:newSpeKey,dayNam: dayNameInput,wrkAry:newWrkAry};
          ...
          const updatedExercises = gettedSelectedExercises.map((workoutData) => {
            ...
            //   imageName = imageUri;
            // }
            // // console.log('imageName updatedExercises',imageName);
            ...
            //   }
            // }
            // console.log('videoName updatedExercises',videoName);
            // console.log('videoUri updatedExercises',videoUri);
            // console.log('videoExt updatedExercises',videoExt);
            // console.log('before  workoutInfo',storedUserConst?.['role']);
          ...
          // WorkoutsFormData.append('trneId', publicWorkoutsPlanRowConArr?.trneId);
          ...
          //   // console.log('workout gettedSelectedExercises',workout);
          ...
          //       }
          //     }
          //     // console.log('imageUri index gettedSelectedExercises',index, imageUri);
          //     // console.log('imageName index gettedSelectedExercises',index,imageName);
          //     // console.log('imageExt index gettedSelectedExercises',index, imageExt);
          ...
          //       } 
          //     }
          //     // console.log('videoUri index gettedSelectedExercises',index,videoUri);
          //     // console.log('videoName index gettedSelectedExercises',index,videoName);
          //     // console.log('videoExt index gettedSelectedExercises',index,videoExt);
          ...
          const WorkoutsObjectData = {
            ...
            trneId:publicWorkoutsPlanRowConArr?.trneId,
          ...
          if(triainerConnected) {
            axios.post(`https://www.elementdevelops.com/api/trainer-trainee-plan-day-insert`,WorkoutsObjectData)
            .then((response) => {
