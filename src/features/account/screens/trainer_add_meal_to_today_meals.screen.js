...
//console.log('item',item);
  ...
  export const TrainerAddNewMealToTodayMealsScreen = ({navigation,route}) => {
const params = route.params || {};

    const { publicWorkoutsPlanRowCon = {}, TrainerTraineeCameData = {} } = params;
  // console.log('TrainerTraineeCameData TrainerAddNewMealToTodayMealsScreen----',TrainerTraineeCameData);
    ...
    const [dayName, setDayName] = useState('');
      ...
      useEffect(() => {
          filterData();
        }, [searchQuery, data,selectedFilter,TrainerTraineeCameData]); 
      ...
      const addEntryHandler = (mealWeight,item) => {
        ...
        // setShowSuccess(false); // Reset success state
          ...
          const certificatesInfo = {
            ...
            mealSpekey:userId + '.' + new Date().getTime(),
