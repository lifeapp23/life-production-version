...
export const TrainerTraineeRequiredMacrosCalculator = ({navigation,onAddEntry}) => {
  ...
  useFocusEffect(
    React.useCallback(() => {
      ...
      AsyncStorage.getItem("currentUser").then((user) => {
        ...
        //console.log('bmi calculator calendar user---->>>',storedUser);
        fetchCalculatorsTableCalNam(storedUser.id,"bmiCal").then((calculatorsResults) => {
          //console.log('calculators bmi calendar Results-->',calculatorsResults);
    ...
    <View>
      <Calendar
        ...
        onDayPress={(day) => {
          ...
          navigation.navigate('TrainerTraineeRequiredMacrosPage',{dayWorkoutWorkedTask:dayWorkoutWorkedTask,sentPassNewDate:presseddDateString})
          onAddEntry();
        }}
      />
      <Spacer size="large">
        ...
        <View style={styles.centeredView}>
          ...
          {(!task)?
            ...
            <DataTable >
              ...
              {/* <DataTable.Row>
                <DataTableCellKey ><DataTableCellKeyText >Methods</DataTableCellKeyText></DataTableCellKey>
              ...
              <DataTable.Row>
                ...
                <DataTableCellValue numeric><DataTableCellValueText >{task?.result} {t('kg_m2')}</DataTableCellValueText></DataTableCellValue>
              </DataTable.Row>
